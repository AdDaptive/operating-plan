              ...
              <div className="flex flex-col gap-5">
                {myTaskGroups.map((group) => (
                  ...
                  >
                    ...
                    <div className="hidden gap-3 px-5 py-2 text-[10.5px] font-bold tracking-wide text-ink-tertiary md:grid md:grid-cols-[1fr_1fr_120px_130px]">
                      <span>TASK</span>
                    ...
                    {group.tasks.map((task) => {
                      ...
                      return (
                        <div
                          key={task.id}
                          className="flex flex-col gap-2 border-t border-[#F2F4F7] px-5 py-3 md:grid md:grid-cols-[1fr_1fr_120px_130px] md:items-start md:gap-3"
                        >
                          ...
                          <span className="min-w-0 truncate text-[13px] text-ink-secondary md:pt-0.5">
                    ...
                    >
                      ...
                      {group.tasks.map((task) => {
                        ...
                        return (
                          <div
                            key={task.id}
                            className="flex flex-col gap-2 border-t border-[#F2F4F7] px-5 py-3 md:grid md:grid-cols-[1fr_1fr_120px_130px] md:items-center md:gap-3"
                          >
                            <div className="flex min-w-0 items-center gap-2.5">
                              <div
